...
public class FollowPlanFracturedLow extends AppCompatActivity {
    ...
    private void checkAndResetIfNewDay() {
        String lastSavedDate = sharedPreferences.getString("lastSavedDate_fractured_low", "");
    ...
    private void saveProgress() {
        ...
        dayData.put("planType", "fractured_low");
        ...
        db.child("Users").child(uid)
                ...
                .addOnSuccessListener(unused -> {
                    ...
                    sharedPreferences.edit()
                            .putString("lastSavedDate_fractured_low", today)
                            .apply();

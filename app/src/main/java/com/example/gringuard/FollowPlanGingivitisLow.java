...
public class FollowPlanGingivitisLow extends AppCompatActivity {
    ...
    private void checkAndResetIfNewDay() {
        String lastSavedDate = sharedPreferences.getString("lastSavedDate_gingivitis_low", "");
    ...
    private void saveProgress() {
        ...
        dayData.put("planType", "gingivitis_low");
        ...
        db.child("Users").child(uid)
                ...
                .addOnSuccessListener(unused -> {
                    ...
                    sharedPreferences.edit()
                            .putString("lastSavedDate_gingivitis_low", today)
                            .apply();

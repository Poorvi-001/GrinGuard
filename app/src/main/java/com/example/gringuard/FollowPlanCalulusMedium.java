...
public class FollowPlanCalulusMedium extends AppCompatActivity {
    ...
    private void checkAndResetIfNewDay() {
        String lastSavedDate = sharedPreferences.getString("lastSavedDate_calculus_medium", "");
    ...
    private void saveProgress() {
        ...
        dayData.put("planType", "calculus_medium");
        ...
        db.child("Users").child(uid)
                ...
                .addOnSuccessListener(unused -> {
                    ...
                    sharedPreferences.edit()
                            .putString("lastSavedDate_calculus_medium", today)
                            .apply();

...
public class FollowPlanCalculusLow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.follow_plan_calculus_low);
    ...
    private void checkAndResetIfNewDay() {
        String lastSavedDate = sharedPreferences.getString("lastSavedDate_calculus_low", "");
    ...
    private void saveProgress() {
        ...
        dayData.put("planType", "calculus_low");
        ...
        db.child("Users").child(uid)
                ...
                .addOnSuccessListener(unused -> {
                    ...
                    sharedPreferences.edit()
                            .putString("lastSavedDate_calculus_low", today)
                            .apply();

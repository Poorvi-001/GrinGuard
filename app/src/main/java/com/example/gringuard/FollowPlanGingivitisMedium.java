...
public class FollowPlanGingivitisMedium extends AppCompatActivity {
    ...
    private void checkAndResetIfNewDay() {
        String lastSavedDate = sharedPreferences.getString("lastSavedDate_gingivitis_medium", "");
    ...
    private void saveProgress() {
        ...
        dayData.put("planType", "gingivitis_medium");
        ...
        db.child("Users").child(uid)
                ...
                .addOnSuccessListener(unused -> {
                    ...
                    sharedPreferences.edit()
                            .putString("lastSavedDate_gingivitis_medium", today)
                            .apply();
